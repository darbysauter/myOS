...
pub fn create_new_user_stack_and_map(frame_alloc: &mut LinkedListFrameAllocator, pml4: &mut PML4, heap_regions: &Vec<(&'static PhysPage4KiB, usize)>) -> &'static VirtPage4KiB {
    ...
    unsafe {
        return &*(last_page as *const VirtPage4KiB)
    }
}
