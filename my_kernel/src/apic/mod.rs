...
pub fn get_apic_base() -> u64 {
    unsafe { read_msr(IA32_APIC_BASE_MSR) & 0xffff_ffff_ffff_f000 }
}

/// # Safety
/// Assumes `base` is a valid address
pub unsafe fn set_apic_base(base: u64) {
    write_msr(IA32_APIC_BASE_MSR, base)
}

/// # Safety
/// Assumes `base` is a valid address to an apic
...
/// # Safety
/// Assumes `base` is a valid address to an apic
pub unsafe fn start_apic_timer(base: u64) {
